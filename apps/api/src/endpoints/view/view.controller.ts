...
export class ViewController {
  ...
  @Get('/proposals/:nonce')
  @ApiParam({ name: 'nonce', description: 'The proposal\'s nonce', required: false })
  ...
  @ApiParam({ name: 'address', description: 'The address to fetch the voting power for', required: false })
  ...
  @ApiParam({ name: 'address', description: 'The address that delegated the voting power', required: false })
  @ApiParam({ name: 'delegatedAddress', description: 'The address that voting power was delegated for', required: false })
